...
"""
MOSAIC -- HMM Regime Classifier (Week 4, TUNED)

Risk-Off no longer means zero exposure. It means reduced exposure.
This prevents the system from sitting in cash during extended periods
...
# TUNED: Risk-Off now has 0.25 exposure instead of 0.0
# This prevents sitting in cash for years and missing rallies
REGIME_SCALARS = {
    0: 1.0,    # Risk-On: full exposure
    1: 0.6,    # Transitional: 60% (was 0.5)
    2: 0.25,   # Risk-Off: 25% exposure (was 0.0 -- this was the main problem)
}
